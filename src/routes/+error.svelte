...
<div class="flex flex-col items-center justify-center py-20 text-center">
	<div class="rounded-lg bg-[--surface-1] px-10 py-10 max-w-md w-full" style="box-shadow: var(--shadow-md)">
		<!-- Icon -->
		<div class="mb-5 text-[--text-disabled]">
			{#if icon === 'missing'}
				<!-- Search/not found icon -->
				<svg class="mx-auto" width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
